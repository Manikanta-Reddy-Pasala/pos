...
const RawMaterials = (props) => {
  ...
  const { setRawMaterialData } = store.ProductStore;
  ...
  return (
    <>
      <Dialog
        open={rawMaterialOpenDialog}
        onClose={handleRawMaterialModalClose}
        fullWidth
        maxWidth="lg"
        PaperProps={{
          style: {
...
export default injectWithObserver(RawMaterials);