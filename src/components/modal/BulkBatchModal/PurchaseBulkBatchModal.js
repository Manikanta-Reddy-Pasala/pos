...
import Moreoptions from 'src/components/MoreoptionsBatch';
...
const PurchaseBulkBatchModal = (props) => {
  ...
  useEffect(() => {
    if (
      OpenPurchaseBulkBatchList === true &&
      singleBatchData &&
  ...
  }, [OpenPurchaseBulkBatchList, menuTypeList]);

  const batchNumberExists = () => {
    let result = selectedPurchaseItem.batches.find(
      (e) =>
        e.batchNumber === singleBatchData.batchNumber &&
        e.id !== singleBatchData.id
    );
  ...
  return (
    <div>
      <Controls.Button
        ...
        onClick={() => handleCloseBulkBatchModal()}
      />

      <Dialog
        open={OpenPurchaseBulkBatchList}
        fullWidth={true}
        maxWidth={'lg'}
      ...
      >
        ...
        <DialogContent>
          <Grid fluid className="app-main">
            {selectedPurchaseItem.batches.length > 0 && (
              <Grid fluid className="app-main">
                    ...
                    <Grid item xs={12} className="grid-padding">
                      ...
                      >
                        <AgGridReact
                          ...
                          suppressMenuHide
                          rowData={selectedPurchaseItem.batches}
                      ...
                      >
                        ...
                        <tbody>
                          {selectedPurchaseItem.batches.map((batchData) => (
                            <tr>
                              {singleBatchData.properties.length > 0 &&
                      ...
                      <div className={classes.prop_box}>
                        ...
                        <div className={classes.w_5}>
                          <IconButton
                            ...
                            className="closeButton"
                            style={{ top: '4px' }}
                            onClick={() => removeSelectedProperty(selectedProp)}
                          >
                            <CancelRoundedIcon />
                          </IconButton>
                        </div>
...
export default injectWithObserver(PurchaseBulkBatchModal);