...
function Moreoptions(props) {
  ...
  const { viewOrEditItem, deletePaymentOut } = store.PaymentOutStore;
  ...
  const downloadPDF = async () => {
    ...
    await axios
      .get(`${API_SERVER}/pos/v1/download/paymentOut`, {
      ...
      .then((res) => {
        ...
        link.href = url;
        let fileName = 'Payment_Out_' + props.item.receiptNumber + '.pdf';
