...
const LinkPaymentSalesReturn = ({ open, onClose, isEditAllowed }) => {
  ...
  const autoLinkClicked = () => {
    ...
    const recievedAmount = parseFloat(returnDetails.paid_amount) || 0;
      ...
      <DialogContent>
        <Grid container spacing={3}>
          ...
          <Grid item xs={2} style={{ flexDirection: 'row' }}>
            <Typography>Paid on Return</Typography>
            <Typography style={{ marginTop: 5 }}>
              {returnDetails.paid_amount}
            </Typography>
          </Grid>
...
export default InjectObsrvable(LinkPaymentSalesReturn);
