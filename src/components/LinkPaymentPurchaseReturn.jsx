...
const LinkPaymentPurchaseReturn = ({ open, onClose, isEditAllowed }) => {
  ...
  const handleClick = (event, row) => {
    if (returnDetails.balance_amoun > 0) {
    }
  ...
  const autoLinkClicked = () => {
    const totalAmount = returnDetails.total_amount;
    const recievedAmount = parseFloat(returnDetails.received_amount) || 0;
    let linkedAmount = parseFloat(returnDetails.linked_amount) || 0;
      ...
      <DialogContent>
        <Grid container spacing={3}>
          ...
          <Grid item xs={2} style={{ flexDirection: 'row' }}>
            <Typography>Received on Return</Typography>
            <Typography style={{ marginTop: 5 }}>
              {returnDetails.received_amount}
            </Typography>
          </Grid>
          ...
          <Grid item xs={2} style={{ flexDirection: 'row' }}>
            ...
            <Input
              ...
              value={returnDetails.linked_amount}
              disabled={true}
              fullWidth
              onChange={(e) => {
        ...
        {/* <Selectmenu
          date="Transaction"
          value={transaction}
          onChange={transactionlistChange}
                        ...
                        <TableRow
                          ...
                          onClick={(event) =>
                            isItemSelected
                              ...
                              : returnDetails.balance_amount > 0
                              ? handleClick(event, row)
                              : ''
                          }
                          style={{
...
export default InjectObsrvable(LinkPaymentPurchaseReturn);
