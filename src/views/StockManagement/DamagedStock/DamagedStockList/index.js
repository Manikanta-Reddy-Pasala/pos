...
const DamagedStockList = (props) => {
  ...
  return (
    <div>
      <Page className={classes.root} title="Damaged Stock">
        {/* <PageHeader /> */}
        ...
        <Paper className={classes.paperRoot}>
          ...
          {alterStockOpenDialog ? (
            <StockModal operationType="Damage Stock" />
          ) : null}
        </Paper>
      </Page>
      <Dialog
...
export default InjectObserver(DamagedStockList);