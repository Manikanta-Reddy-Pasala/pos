...
const RemoveStockList = (props) => {
  ...
  return (
    <div>
      <Page className={classes.root} title="Remove Stock">
        {/* <PageHeader /> */}
        ...
        <Paper className={classes.paperRoot}>
          ...
          {alterStockOpenDialog ? (
            <StockModal operationType="Remove Stock" />
          ) : null}
        </Paper>
      </Page>
      <Dialog
...
export default InjectObserver(RemoveStockList);