...
const PurchaseSplitPaymentDetails = (props) => {
  ...
  const saveSplitPaymentDetails = async () => {
    if (getTotalAmount() !== billDetails.total_amount) {
      setErrorAlertProductMessage(
  ...
  const getTotalAmountGiven = () => {
    ...
    let amount = billDetails.total_amount - result;
        ...
        <div>
          <div>
            {billDetails &&
              billDetails.splitPaymentList &&
              billDetails.splitPaymentList.length > 0 &&
              billDetails.splitPaymentList.map((option, index) => (
                <div>
                  <div
                    style={{
                      width: '100%',
      ...
      <DialogActions>
        <div>
          <b style={{ marginRight: '20px' }}>
            TOTAL: {billDetails.total_amount}
          </b>
          <b style={{ marginRight: '20px' }}>
...
export default PurchaseSplitPaymentDetails;