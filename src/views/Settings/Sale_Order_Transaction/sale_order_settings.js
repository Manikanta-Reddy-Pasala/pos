...
const SaleOrderSettings = () => {
  const classes = useStyles();
  const navigate = useNavigate();
  const stores = useStore();

  const {
    setSaleOrderTxnSettingProperty,
    getSaleOrderTransSettingdetails,
    setBillTerms
  } = stores.SaleOrderTransactionSettingsStore;
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      /*if (
        ...
        saleOrderTransSettingData.enableOnTxn &&
        saleOrderTransSettingData.enableOnTxn.productLevel &&
        saleOrderTransSettingData.enableOnTxn.productLevel.length > 0 &&
        saleOrderTransSettingData.terms === ''
      ) {
                ...
                >
                  ...
                  >
                    <Grid item xs={12} sm={3}>
                      ...
                      <Divider variant="li" />
                      {saleOrderTransSettingData.enableOnTxn.productLevel.map(
                        (prodEle, index) => (
                          <div>
                    ...
                    <Grid item xs={12} sm={3}>
                      ...
                      <Divider variant="li" />
                      {saleOrderTransSettingData.enableOnTxn.billLevel.map(
                        (billEle, index) => (
                          <div>
                            <FormControl variant="standard">
                              <FormControlLabel
                  ...
                  >
                    <Grid item xs={12} sm={3}>
                      ...
                      <Divider variant="li" />
                      {saleOrderTransSettingData.displayOnBill.productLevel.map(
                        (prodEle, index) => (
                          <div>
                            <FormControl variant="standard">
                              <FormControlLabel
                    ...
                    <Grid item xs={12} sm={3}>
                      ...
                      <Divider variant="li" />
                      {saleOrderTransSettingData.displayOnBill.billLevel.map(
                        (billEle, index) => (
                          <div>
                            <FormControl variant="standard">
                              <FormControlLabel
                  ...
                  {saleOrderTransSettingData.enableOnTxn.productLevel &&
                    saleOrderTransSettingData.enableOnTxn.productLevel.length >
                      0 && (
                        ...
                        <Grid style={{ display: 'flex' }} item xs={12}>
                          <MuiThemeProvider theme={theme}>
                            <TextField
                              ...
                              variant="outlined"
                              style={{ width: '100%' }}
                              value={saleOrderTransSettingData.terms}
                              onChange={(e) => {
...
export default injectWithObserver(SaleOrderSettings);