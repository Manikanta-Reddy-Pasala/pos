...
const ApprovalTransactionSettings = () => {
  const classes = useStyles();
  const navigate = useNavigate();
  const stores = useStore();

  const {
    setApprovalTxnSettingProperty,
    getApprovalTransSettingdetails,
    setBillTerms
  } = stores.ApprovalTransactionSettingsStore;
  ...
  useEffect(() => {
    async function fetchData() {
     ...
     /* if (
        ...
        approvalTransSettingData.enableOnTxn &&
        approvalTransSettingData.enableOnTxn.productLevel &&
        approvalTransSettingData.enableOnTxn.productLevel.length > 0 &&
        approvalTransSettingData.terms === ''
      ) {
                ...
                >
                  ...
                  >
                    <Grid item xs={12} sm={3}>
                      ...
                      <Divider variant="li" />
                      {approvalTransSettingData.enableOnTxn.productLevel.map(
                        (prodEle, index) => (
                          <div>
                    ...
                    <Grid item xs={12} sm={3}>
                      ...
                      <Divider variant="li" />
                      {approvalTransSettingData.enableOnTxn.billLevel.map(
                        (billEle, index) => (
                          <div>
                            <FormControl variant="standard">
                              <FormControlLabel
                  ...
                  >
                    <Grid item xs={12} sm={3}>
                      ...
                      <Divider variant="li" />
                      {approvalTransSettingData.displayOnBill.productLevel.map(
                        (prodEle, index) => (
                          <div>
                            <FormControl variant="standard">
                              <FormControlLabel
                    ...
                    <Grid item xs={12} sm={3}>
                      ...
                      <Divider variant="li" />
                      {approvalTransSettingData.displayOnBill.billLevel.map(
                        (billEle, index) => (
                          <div>
                            <FormControl variant="standard">
                              <FormControlLabel
                  ...
                  {approvalTransSettingData.enableOnTxn.productLevel &&
                    approvalTransSettingData.enableOnTxn.productLevel.length >
                      0 && (
                        ...
                        <Grid style={{ display: 'flex' }} item xs={12}>
                          <MuiThemeProvider theme={theme}>
                            <TextField
                              ...
                              variant="outlined"
                              style={{ width: '100%' }}
                              value={approvalTransSettingData.terms}
                              onChange={(e) => {
...
export default injectWithObserver(ApprovalTransactionSettings);