...
const JobWorkInSettings = () => {
  const classes = useStyles();
  const navigate = useNavigate();
  const stores = useStore();

  const {
    setJobWorkInTxnSettingProperty,
    getJobWorkInTransSettingdetails,
    setBillTerms
  } = stores.JobWorkInTransactionSettingsStore;
  ...
  useEffect(() => {
    async function fetchData() {
     ...
     /* if (
        ...
        jobWorkInTransSettingData.enableOnTxn &&
        jobWorkInTransSettingData.enableOnTxn.productLevel &&
        jobWorkInTransSettingData.enableOnTxn.productLevel.length > 0 &&
        jobWorkInTransSettingData.terms === ''
      ) {
                ...
                >
                  ...
                  >
                    <Grid item xs={12} sm={3}>
                      ...
                      <Divider variant="li" />
                      {jobWorkInTransSettingData.enableOnTxn.productLevel.map(
                        (prodEle, index) => (
                          <div>
                    ...
                    <Grid item xs={12} sm={3}>
                      ...
                      {jobWorkInTransSettingData.enableOnTxn.billLevel.map(
                        (billEle, index) => (
                          <div>
                            <FormControl variant="standard">
                              <FormControlLabel
                  ...
                  >
                    <Grid item xs={12} sm={3}>
                      ...
                      <Divider variant="li" />
                      {jobWorkInTransSettingData.displayOnBill.productLevel.map(
                        (prodEle, index) => (
                          <div>
                            <FormControl variant="standard">
                              <FormControlLabel
                    ...
                    <Grid item xs={12} sm={3}>
                      ...
                      <Divider variant="li" />
                      {jobWorkInTransSettingData.displayOnBill.billLevel.map(
                        (billEle, index) => (
                          <div>
                            <FormControl variant="standard">
                              <FormControlLabel
                  ...
                  {jobWorkInTransSettingData.enableOnTxn.productLevel &&
                    jobWorkInTransSettingData.enableOnTxn.productLevel.length >
                      0 && (
                        ...
                        <Grid style={{ display: 'flex' }} item xs={12}>
                          <MuiThemeProvider theme={theme}>
                            <TextField
                              ...
                              variant="outlined"
                              style={{ width: '100%' }}
                              value={jobWorkInTransSettingData.terms}
                              onChange={(e) => {
...
export default injectWithObserver(JobWorkInSettings);