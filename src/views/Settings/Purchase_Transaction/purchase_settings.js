...
const PurchaseSettings = () => {
  ...
  const {
    setPurchaseTxnSettingProperty,
    getPurchaseTransSettingdetails,
    setBillTerms,
    setEnableTCS,
    setEnableTDS,
    setUpdatePurchasePriceFromTransaction
  } = stores.PurchaseTransSettingsStore;

  const { purchaseTransSettingData } = toJS(stores.PurchaseTransSettingsStore);
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      /*if (
        ...
        purchaseTransSettingData.enableOnTxn &&
        purchaseTransSettingData.enableOnTxn.productLevel &&
        purchaseTransSettingData.enableOnTxn.productLevel.length > 0 &&
        purchaseTransSettingData.terms === ''
      ) {
        ...
        {!isLoading && (
          <>
            {isFeatureAvailable ? (
              ...
              >
                {purchaseTransSettingData.enableOnTxn.productLevel &&
                  purchaseTransSettingData.enableOnTxn.productLevel.length >
                    0 && (
                    <>
                      <Grid
                        item
                      ...
                      >
                        ...
                        >
                          <FormControlLabel
                            control={
                              <Switch
                                checked={purchaseTransSettingData.enableTDS}
                                onChange={(e) => {
                      ...
                      >
                        ...
                        >
                          <FormControlLabel
                            control={
                              <Switch
                                checked={purchaseTransSettingData.enableTCS}
                                onChange={(e) => {
                                  setEnableTCS(e.target.checked);
                                }}
                              />
                            }
                            label="Enable TCS"
                        ...
                        <Grid>
                          <FormControlLabel
                            control={
                              <Switch
                                checked={
                                  purchaseTransSettingData.updatePurchasePriceFromTransaction
                                }
                                onChange={(e) => {
                                  setUpdatePurchasePriceFromTransaction(
                                    e.target.checked
                            ...
                            label="Update Purchase Price of Product from Transaction"
                          />
                          <Typography style={{ marginBottom: '16px' }}>
                            NOTE: Product price is always overridden by latest
                            Purchase Price
                          </Typography>
                        </Grid>
                      </Grid>
                ...
                >
                  ...
                  >
                    <Grid item xs={12} sm={3}>
                      ...
                      <Divider variant="li" />
                      {purchaseTransSettingData.enableOnTxn.productLevel.map(
                        (prodEle, index) => (
                          <div>
                    ...
                    <Grid item xs={12} sm={3}>
                      ...
                      <Divider variant="li" />
                      {purchaseTransSettingData.enableOnTxn.billLevel.map(
                        (billEle, index) => (
                          <div>
                            <FormControl variant="standard">
                              <FormControlLabel
                  ...
                  >
                    <Grid item xs={12} sm={3}>
                      ...
                      <Divider variant="li" />
                      {purchaseTransSettingData.displayOnBill.productLevel.map(
                        (prodEle, index) => (
                          <div>
                            <FormControl variant="standard">
                              <FormControlLabel
                    ...
                    <Grid item xs={12} sm={3}>
                      ...
                      <Divider variant="li" />
                      {purchaseTransSettingData.displayOnBill.billLevel.map(
                        (billEle, index) => (
                          <div>
                            <FormControl variant="standard">
                              <FormControlLabel
                        ...
                        <Grid style={{ display: 'flex' }} item xs={12}>
                          <MuiThemeProvider theme={theme}>
                            <TextField
                              ...
                              variant="outlined"
                              style={{ width: '100%' }}
                              value={purchaseTransSettingData.terms}
                              onChange={(e) => {
...
export default injectWithObserver(PurchaseSettings);