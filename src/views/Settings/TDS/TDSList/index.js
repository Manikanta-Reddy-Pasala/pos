...
import MoreOptionsTDS from 'src/components/MoreOptionsTDS';
import AddTDS from '../AddTDS';
...
const TDSList = () => {
  ...
  const { handleTDSModalOpen, getTDS } = store.TDSStore;
  const { tdsList } = toJS(store.TDSStore);
  ...
  return (
    <Page className={classes.root} title="TDS">
...
export default InjectObserver(TDSList);
