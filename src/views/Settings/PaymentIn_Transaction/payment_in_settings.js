...
const PaymentInSettings = () => {
  ...
  } = stores.PaymentInTransSettingsStore;

  const { paymentInTransSettingData } = toJS(
    stores.PaymentInTransSettingsStore
  );
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      /*if (paymentInTransSettingData && paymentInTransSettingData.terms === '') {
                    ...
                    <Grid style={{ display: 'flex' }} item xs={12}>
                      <MuiThemeProvider theme={theme}>
                        <TextField
                          ...
                          variant="outlined"
                          style={{ width: '100%' }}
                          value={paymentInTransSettingData.terms}
                          onChange={(e) => {
...
export default injectWithObserver(PaymentInSettings);