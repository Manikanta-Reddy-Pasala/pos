...
const DeliveryChallanSettings = () => {
  ...
  const {
    ...
    setBillTerms
  } = stores.DeliveryChallanTransactionSettingsStore;
  ...
  useEffect(() => {
    async function fetchData() {
     ...
     /* if (
        ...
        deliveryChallanTransSettingData.enableOnTxn &&
        deliveryChallanTransSettingData.enableOnTxn.productLevel &&
        deliveryChallanTransSettingData.enableOnTxn.productLevel.length > 0 &&
        deliveryChallanTransSettingData.terms === ''
      ) {
        ...
        <Card className={classes.card}>
          <Grid container className={classes.cardList}>
            <TransactionSettingsNavigation
              navigation={navigate}
              active="delivery_challan_settings"
            />
          </Grid>
        </Card>
      </Col>
                ...
                >
                  ...
                  >
                    <Grid item xs={12} sm={3}>
                      ...
                      <Divider variant="li" />
                      {deliveryChallanTransSettingData.enableOnTxn.productLevel.map(
                        (prodEle, index) => (
                          <div>
                    ...
                    <Grid item xs={12} sm={3}>
                      ...
                      <Divider variant="li" />
                      {deliveryChallanTransSettingData.enableOnTxn.billLevel.map(
                        (billEle, index) => (
                          <div>
                            <FormControl variant="standard">
                              <FormControlLabel
                  ...
                  >
                    <Grid item xs={12} sm={3}>
                      ...
                      <Divider variant="li" />
                      {deliveryChallanTransSettingData.displayOnBill.productLevel.map(
                        (prodEle, index) => (
                          <div>
                            <FormControl variant="standard">
                              <FormControlLabel
                    ...
                    <Grid item xs={12} sm={3}>
                      ...
                      {deliveryChallanTransSettingData.displayOnBill.billLevel.map(
                        (billEle, index) => (
                          <div>
                            <FormControl variant="standard">
                              <FormControlLabel
                        ...
                        <Grid style={{ display: 'flex' }} item xs={12}>
                          <MuiThemeProvider theme={theme}>
                            <TextField
                              ...
                              variant="outlined"
                              style={{ width: '100%' }}
                              value={deliveryChallanTransSettingData.terms}
                              onChange={(e) => {
...
export default injectWithObserver(DeliveryChallanSettings);
