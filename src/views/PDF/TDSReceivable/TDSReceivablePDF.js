...
import LedgerPDFTableHeader from './TDSReceivablePDFTableHeader';
import LedgerPDFTableRow from './TDSReceivablePDFTableRow';
...
const TDSReceivablePDF = (props) => (
  <Document>
    <Page size="A4" orientation="landscape" style={styles.page}>
      ...
      <View style={styles.titleContainer}>
        <Text style={styles.ledgerTitle}>TDS Receivable</Text>
      </View>

      <View style={styles.titleContainer}>
        <Text style={styles.customerTitle}>Date: {props.date}</Text>
      </View>
...
export default TDSReceivablePDF;