...
import LedgerPDFTableHeader from './ExchangeBookPDFTableHeader';
import LedgerPDFTableRow from './ExchangeBookPDFTableRow';
import LedgerPDFTableFooter from './ExchangeBookPDFTableFooter';
...
const ExchangeBookPDF = (props) => (
  <Document>
    <Page size="A4" orientation="landscape" style={styles.page}>
      ...
      <View style={styles.titleContainer}>
        <Text style={styles.ledgerTitle}>Exchange Book</Text>
      </View>
...
export default ExchangeBookPDF;