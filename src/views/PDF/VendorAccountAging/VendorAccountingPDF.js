...
import LedgerPDFTableHeader from './VendorAccountingPDFTableHeader';
import LedgerPDFTableRow from './VendorAccountingPDFTableRow';
import LedgerPDFTableFooter from './VendorAccountingPDFTableFooter';
...
const VendorAccountingPDF = (props) => (
  <Document>
    <Page size="A4" orientation="landscape" style={styles.page}>
      ...
      <View style={styles.tableContainer}>
        ...
        />
        <LedgerPDFTableFooter type={props.type} total={props.total} />
      </View>
    </Page>
  </Document>
);
export default VendorAccountingPDF;