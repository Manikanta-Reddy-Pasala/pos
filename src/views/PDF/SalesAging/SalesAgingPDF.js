...
import LedgerPDFTableHeader from './SalesAgingPDFTableHeader';
import LedgerPDFTableRow from './SalesAgingPDFTableRow';
...
const SalesAgingPDF = (props) => (
  <Document>
    <Page size="A4" orientation="landscape" style={styles.page}>
      ...
      <View style={styles.titleContainer}>
        <Text style={styles.ledgerTitle}>Sale Aging Details By Invoice Due Date</Text>
      </View>
