...
import LedgerPDFTableHeader from './PurchasesAgingPDFTableHeader';
import LedgerPDFTableRow from './PurchasesAgingPDFTableRow';
...
const PurchasesAgingPDF = (props) => (
  <Document>
    <Page size="A4" orientation="landscape" style={styles.page}>
      ...
      <View style={styles.titleContainer}>
        <Text style={styles.ledgerTitle}>Purchase Aging Details By Bill Due Date</Text>
      </View>

      <View style={styles.titleContainer}>
        <Text style={styles.customerTitle}>Due Date: {props.date}</Text>
      </View>
...
export default PurchasesAgingPDF;