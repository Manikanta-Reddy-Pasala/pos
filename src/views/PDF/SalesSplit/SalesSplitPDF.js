...
import SalesSplitPDFTableHeader from './SalesSplitPDFTableHeader';
import SalesSplitPDFTableRow from './SalesSplitPDFTableRow';
...
const DayBookPDF = (props) => (
  <Document>
    <Page size="A4" orientation="landscape" style={styles.page}>
      ...
      <View style={styles.titleContainer}>
        <Text style={styles.ledgerTitle}>ALL SALES (HSN)</Text>
      </View>
      ...
      <View style={styles.tableContainer}>
        <SalesSplitPDFTableHeader />
        <SalesSplitPDFTableRow
          items={props.data}
        />
