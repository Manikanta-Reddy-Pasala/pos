...
import SaleProductPDFTableHeader from './SaleProductPDFTableHeader';
import SaleProductPDFTableRow from './SaleProductPDFTableRow';
  ...
  <Document>
    <Page size="A4" orientation="landscape" style={styles.page}>
      ...
      <View style={styles.tableContainer}>
        <SaleProductPDFTableHeader page={props.page} />
        <SaleProductPDFTableRow
          items={props.data}
          page={props.page}
        />
