...
import LedgerPDFTableHeader from './CustomerAccountingPDFTableHeader';
import LedgerPDFTableRow from './CustomerAccountingPDFTableRow';
import LedgerPDFTableFooter from './CustomerAccountingPDFTableFooter';
...
const CustomerAccountingPDF = (props) => (
  <Document>
    <Page size="A4" orientation="landscape" style={styles.page}>
      ...
      <View style={styles.tableContainer}>
        <LedgerPDFTableHeader type={props.type} />
        <LedgerPDFTableRow
          items={props.data}
          type={props.type}
        ...
        />
        <LedgerPDFTableFooter total={props.total} type={props.type} />
      </View>
    </Page>
  </Document>
);
export default CustomerAccountingPDF;