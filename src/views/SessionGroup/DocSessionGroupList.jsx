...
const DocSessionGroupList = (props) => {
  ...
  const handleRowClicked = (e) => {
   ...
   setRowNumber(e.rowIndex);
  }

  return (
    <div>
         <div style={{ width: '100%', height: height - 238 + 'px' }}>
            <div
            ...
            <AgGridReact
                ...
                ></div>
                 {props.addSessionNotesDialogOpen && <AddSessionNotes data={clickedRowData} rowNumber={rowNumber} />}
                </div>
                </div>
    </div>
  );
};
export default InjectObserver(DocSessionGroupList);