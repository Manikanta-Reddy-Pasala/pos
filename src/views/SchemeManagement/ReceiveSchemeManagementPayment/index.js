...
import ReceivePaymentInSplitPaymentDetails from 'src/components/modal/ReceivePaymentInSplitPaymentDetails';
...
const ReceiveSchemeManagementPayment = (props) => {
  ...
  const {
    savePaymentData,
    closeReceivePaymentSchemeDialog,
  ...
  return (
    <div>
      <Dialog
        ...
        fullWidth={true}
        maxWidth={'lg'}
        open={openReceivePaymentForScheme}
        onClose={closeReceivePaymentSchemeDialog}
...
export default injectWithObserver(ReceiveSchemeManagementPayment);