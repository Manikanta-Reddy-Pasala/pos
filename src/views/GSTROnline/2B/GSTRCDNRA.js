      ...
      <table className={`${classes.batchTable}`} style={{ fontSize: '12px' }}>
        <thead>
          <tr>
            ...
            <th colspan="5" style={{ textAlign: 'center' }} className={`${classes.headstyle} ${classes.rowstyle}`}>
              ...
              {item?.nt?.map((itemb, indexb) => (
                <React.Fragment key={indexb}>
                  <tr>
                    ...
                    <td className={`${classes.rowstyle}`}>
                      <p style={{ color: 'blue' }} onClick={() => handleViewClick(itemb.ontnum)}>View</p>
                    </td>
                    <td className={`${classes.rowstyle}`}>
                      {item.supfildt}
                    </td>
                  ...
                  <tr>
                    <td colSpan="15">
                      {openIndex === itemb.ontnum && (
                        <div className={classes.invGrid}>
                          {itemb.items.map((itemi, i) => (<Grid container spacing={2}>
