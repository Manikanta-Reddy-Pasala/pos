...
const GSTRB2B = (props) => {
  ...
  const { b2b2AData, updateB2BData } = stores.GSTR2AStore;
  ...
  return (
    <>
      <table
        ...
        style={{ fontSize: '12px', overflowY: 'scroll' }}
      >
        <thead>
          <tr>
            <th
              ...
              {item?.inv?.map((itemb, indexb) => (
                <React.Fragment key={indexb}>
                  <tr>
                    ...
                    <td className={`${classes.rowstyle}`}>{item.cfs3b}</td>
                    <td className={`${classes.rowstyle}`}>{item.fldtr1}</td>
                    <td className={`${classes.rowstyle}`}>{item.flprdr1}</td>
                    <td className={`${classes.rowstyle}`}></td>
                    <td className={`${classes.rowstyle}`}></td>
                    ...
                    <td className={`${classes.rowstyle}`}>{itemb.rchrg}</td>
                    <td className={`${classes.rowstyle}`}>{itemb.inv_typ}</td>
                    <td className={`${classes.rowstyle}`}>
                      <p
                        style={{ color: 'blue' }}
