...
const ItemWiseDiscountSales = () => {
  ...
  const getDataFromSalesByItemReport = () => {
    ...
    wb.SheetNames.push('Item Wise Disc Sales Sheet');

    console.log('test:: ws::', ws);
    wb.Sheets['Item Wise Disc Sales Sheet'] = ws;
    ...
    const fileName = 'Item_Wise_Disc_Sales_Report';
...
export default InjectObserver(ItemWiseDiscountSales);