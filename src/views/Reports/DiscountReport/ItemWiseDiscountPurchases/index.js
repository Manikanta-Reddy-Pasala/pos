...
const ItemWiseDiscountPurchases = () => {
    ...
    },
    {
      ...
      valueFormatter: (params) => {
        ...
        if (data['purchaseQty'] && data['purchaseQty'] > 0) {
          result = parseFloat(data['discountAmount'] || 0) / data['purchaseQty'];
        } else {
  ...
  const getDataFromSalesByItemReport = () => {
    ...
    if (rowData && rowData.length > 0) {
      for (var i = 0; i < rowData.length; i++) {
        const record = {
          ...
          'PURCHASE AMOUNT': parseFloat(rowData[i].purchaseAmount || 0).toFixed(2),
          'DISCOUNT AMOUNT': parseFloat(rowData[i].discountAmount || 0).toFixed(2),
    ...
    wb.SheetNames.push('Item Wise Disc Purchases Sheet');

    console.log('test:: ws::', ws);
    wb.Sheets['Item Wise Disc Purchases Sheet'] = ws;
    ...
    const fileName = 'Item_Wise_Disc_Purchases_Report';
              ...
              <div className={classes.content}>
                <div className={classes.contentLeft}>
                  <Typography gutterBottom variant="h4" component="h4">
                    PRODUCT WISE DISCOUNT (PURCHASES)
                  </Typography>
                </div>
              </div>
...
export default InjectObserver(ItemWiseDiscountPurchases);