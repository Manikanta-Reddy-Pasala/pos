...
const TodaySalesReturn = (props) => {
  ...
  const getDataFromSales = async () => {
    ...
    let xlsxReturnDetailsList = await getAllSaleReturnDataByDateXlsx(
      fromDate,
      toDate
    );
    ...
    wb.SheetNames.push('Today Sales Return Sheet');

    console.log('test:: ws::', ws);
    wb.Sheets['Today Sales Return Sheet'] = ws;
    ...
    const fileName = 'Today_Sales_Return_Report';
...
export default InjectObserver(TodaySalesReturn);