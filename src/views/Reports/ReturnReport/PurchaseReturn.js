...
const PurchaseReturn = (props) => {
  ...
  const getDataFromPurchaseReturns = async () => {
    ...
    wb.SheetNames.push('Purchase Returns Sheet');

    console.log('test:: ws::', ws);
    wb.Sheets['Purchase Returns Sheet'] = ws;
    ...
    const fileName = 'Purchase_Returns_Report';
                ...
                >
                  <Grid container direction="row" alignItems="center">
                    ...
                    <Grid item sm={2} className="category-actions-right">
                      <Avatar>
                        <IconButton
                          onClick={() => getDataFromPurchaseReturns()}
                        >
...
export default InjectObserver(PurchaseReturn);
