...
const Gstr9A15Report = (props) => {
  ...
  const GSTR9_15_List = [
      {
          description:'Inward supplies liable to reverse charge received from registered persons',
          taxable_vaues : 0,
          central_tax : 0,
          state_ut_tax : 0,
          integrated_tax : 0,
      ...
      {
        description:'Inward supplies liable to reverse charge received from unregistered persons	',
        taxable_vaues : 0,
        central_tax : 0,
        state_ut_tax : 0,
        integrated_tax : 0,
      ...
      {
        description:'Net Tax payable on (A), (B) and ( C) above',
        taxable_vaues : 0,
        central_tax : 0,
        state_ut_tax : 0,
        integrated_tax : 0,
      ...
      <div>
        <div className={classes.contPad}>
         <div className={classes.headerFour} >
             <p className={classes.r4}>15</p><p style={{display:'inline'}}>Details of inward supplies on which tax is payable on reverse charge basis (net of debit/credit notes) for the financial year</p>
         </div>
         ...
         <div>
             <Grid container className={classes.fourSubHeader}>
                 ...
                 <Grid item xs={1} style={{textAlign:'center'}}>Penalty	</Grid>
                 <Grid item xs={1} style={{textAlign:'center'}}>Late/fee others</Grid>
             ...
             {GSTR9_15_List.map((e,index) => (
                   ...
                   <Grid item xs={2}>{e.description}</Grid>
                   ...
                   <Grid item xs={1} style={{textAlign:'center'}}>{e.late_fee}</Grid>
...
export default InjectObserver(Gstr9A15Report);
