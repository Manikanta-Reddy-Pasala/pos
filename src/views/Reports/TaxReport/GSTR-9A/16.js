...
const Gstr9A16Report = (props) => {
  ...
  const GSTR9_16_List = [
      {
          description:'Credit reversed on opting in the composition scheme (-)',
          taxable_vaues : '',
          central_tax : '',
          state_ut_tax : '',
          integrated_tax : '',
      ...
      {
        description:'Credit availed on opting out of the composition scheme (+)',
        taxable_vaues : '',
        central_tax : '',
        state_ut_tax : '',
        integrated_tax : '',
      ...
      <div>
        <div className={classes.contPad}>
         <div className={classes.headerFour} >
             <p className={classes.r4}>16</p><p style={{display:'inline'}}>Details of credit reversed or availed</p>
         </div>
...
export default InjectObserver(Gstr9A16Report);
