...
const CDNUR5BReport = () => {
  ...
  const { getPurchasesReturnGSTR45BCDNURData } = store.GSTR4Store;
  const { gstr45BCDNURData } = toJS(store.GSTR4Store);

  useEffect(() => {
    async function fetchData() {
      getPurchasesReturnGSTR45BCDNURData();
    }
...
export default InjectObserver(CDNUR5BReport);
