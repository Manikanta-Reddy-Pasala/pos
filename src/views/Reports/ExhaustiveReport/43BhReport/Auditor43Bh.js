...
const Auditor43Bh = (props) => {
  ...
  function getAge(data) {
    var date1 = new Date(data.bill_date);
              ...
              <div className={classes.content}>
                <div className={classes.contentLeft}>
                  <Typography gutterBottom variant="h4" component="h4">
                    Section 43B(h) Income Tax Report
                  </Typography>
                </div>
              </div>
...
export default InjectObserver(Auditor43Bh);