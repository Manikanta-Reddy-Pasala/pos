...
import TodaySalesPDF from 'src/views/PDF/TodaySales/TodaySalesPDF';
...
const SalesByCustomer = (props) => {
  ...
  const getDataFromSalesByCustomer = async () => {
    ...
    wb.SheetNames.push('Sales By Customer Sheet');

    console.log('test:: ws::', ws);
    wb.Sheets['Sales By Customer Sheet'] = ws;
    ...
    const fileName = 'Sales_By_Customer_Report';
...
export default InjectObserver(SalesByCustomer);