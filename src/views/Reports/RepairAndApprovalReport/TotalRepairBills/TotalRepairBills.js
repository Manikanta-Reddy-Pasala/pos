...
const TotalRepairBills = (props) => {
  ...
  const getDataFromSales = async () => {
    ...
    wb.SheetNames.push('All Repair Bills Sheet');

    console.log('test:: ws::', ws);
    wb.Sheets['All Repair Bills Sheet'] = ws;
    ...
    const fileName = 'All_Repair_Bills_Report';
...
export default InjectObserver(TotalRepairBills);
