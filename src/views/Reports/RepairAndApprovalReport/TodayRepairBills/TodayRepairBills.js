...
const TodayRepairBills = (props) => {
  ...
  const getDataFromSales = async () => {
    ...
    wb.SheetNames.push('Today Repair Bills Sheet');

    // console.log('test:: ws::', ws);
    wb.Sheets['Today Repair Bills Sheet'] = ws;
    ...
    const fileName = 'Today_Repair_Bills_Report';
...
export default InjectObserver(TodayRepairBills);
