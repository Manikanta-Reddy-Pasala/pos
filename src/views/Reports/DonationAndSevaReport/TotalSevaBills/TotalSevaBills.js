...
const TotalSevaBills = (props) => {
  ...
  const getDataFromSales = async () => {
    ...
    wb.SheetNames.push('All Seva Bills Sheet');

    console.log('test:: ws::', ws);
    wb.Sheets['All Seva Bills Sheet'] = ws;
    ...
    const fileName = 'All_Seva_Bills_Report';
...
export default InjectObserver(TotalSevaBills);
