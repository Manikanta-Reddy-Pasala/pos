...
const TodaySevaBills = (props) => {
  ...
  const getDataFromSales = async () => {
    ...
    wb.SheetNames.push('Today Seva Bills Sheet');

    // console.log('test:: ws::', ws);
    wb.Sheets['Today Seva Bills Sheet'] = ws;
    ...
    const fileName = 'Today_Seva_Bills_Report';
...
export default InjectObserver(TodaySevaBills);
