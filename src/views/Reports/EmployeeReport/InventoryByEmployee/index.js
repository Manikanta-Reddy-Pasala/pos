...
const InventorybyEmployeeReport = () => {
  ...
  const getData = () => {
    ...
    wb.SheetNames.push('Inventory Sheet');

    console.log('test:: ws::', ws);
    wb.Sheets['Inventory Sheet'] = ws;
    ...
    const fileName = 'Inventory_by_Employee_Report';
...
export default InjectObserver(InventorybyEmployeeReport);
