...
import DeliveryChallanBatchListModal from 'src/components/modal/DeliveryChallanBatchListModal';
...
import DeliveryChallanAddressListModal from 'src/components/modal/AddressListModal/DeliveryChallanAddressListModal';
import * as taxUtilityTxn from 'src/components/Utility/TaxUtility';
import DeliveryChallanSerialListModal from 'src/components/modal/DeliveryChallanSerialListModal';
...
const AddDeliveryChallanInvoice = () => {
  ...
  const {
    ...
    FocusLastIndex,
    openLinkpaymentPage,
    OpenDeliveryChallanBatchList,
    deliveryChallanTxnEnableFieldsMap,
    taxSettingsData,
    isRestore,
    openDCLoadingAlertMessage,
    openDCErrorAlertMessage,
    descriptionCollapsibleMap,
    openAddressList,
    customerAddressList,
    isCGSTSGSTEnabledByPOS,
    sequenceNumberFailureAlert,
    OpenDeliveryChallanSerialList,
    errorAlertMessage,
    openDeliveryChallanErrorAlertMessage
  } = toJS(store.DeliveryChallanStore);
  ...
  const {
    ...
    setPurity,
    setItemHSN,
    setDeliveryChallanTxnEnableFieldsMap,
    setTaxIncluded,
    setTaxSettingsData,
    setMakingCharge,
    ...
    handleOpenDCLoadingMessage,
    handleCloseDCErrorAlertMessage,
    ...
    handleCloseDeliveryChallanErrorAlertMessage,
    setItemRate,
    setRateMetalList,
    setDiscountType,
  ...
  const onPrintAndSaveClicked = async () => {
    ...
    if (
    ...
    } else if (parseFloat(saleDetails.total_amount) === 0) {
      setTotalZeroAlert(true);
    } else if (
      items.length === 0 ||
      ...
      saveData(true)
        ...
        .catch((err) => {
          console.log('Delivery Challan Insertion Failed - ', err);
        });
    }
  };
  ...
  const isProductsValid = async () => {
    ...
    if (
      deliveryChallanTxnEnableFieldsMap.get('enable_product_price') === true
    ) {
      ...
      deliveryChallanTxnEnableFieldsMap.get('enable_product_price_per_gram') ===
      true
    ) {
  ...
  useEffect(() => {
    async function fetchData() {
      setDeliveryChallanTxnEnableFieldsMap(
        await getDeliveryChallanTransSettingdetails()
      );
    }
  ...
  return (
    <div>
      <Dialog
        ...
        fullScreen
        open={OpenAddDeliveryChallanInvoice}
      ...
      >
        ...
        <div className={innerClasses.content} style={{ bottom: '210px' }}>
            ...
            <Table aria-label="simple table">
              <TableHead className={classes.addtablehead} id="myTable">
                <TableRow className="row1">
                  ...
                  {/* HSN */}
                  {deliveryChallanTxnEnableFieldsMap.get(
                    'enable_product_hsn'
                  ) && (
                    <TableCell
                      variant="head"
          ...
          <div style={{ width: '100%' }}>
            {deliveryChallanTxnEnableFieldsMap.get('enable_bill_notes') ? (
              <Grid
                item
                xs={12}
                style={{
        ...
        <div className={[classes.footer]} style={{ height: '210px' }}>
          ...
          <Grid container>
            <Grid item xs={12}>
              <FileUpload onFilesUpload={handleFileUpload} uploadedFiles={saleDetails.imageUrls} />
            </Grid>
          </Grid>
          ...
          >
            ...
            ></Grid>
            <Grid item xs={6} style={{ marginTop: '5px', marginBottom: '5px' }}>
              <Grid
                container
                direction="row"
                spacing={0}
          ...
          >
            <Grid item xs={6} style={{ marginTop: '30px' }}>
              <>
                {saleDetails.status === 'close' && isRestore === true && (
                  <Button
                    variant="outlined"
                    color="secondary"
        ...
        {openLinkpaymentPage ? (
          <LinkPaymentSales onClose={closeLinkPayment} />
        ) : null}

        {OpenDeliveryChallanBatchList ? (
          <DeliveryChallanBatchListModal
        ...
        {OpenDeliveryChallanSerialList ? (
          <DeliveryChallanSerialListModal
            productDetail={selectedProduct}
            selectedIndex={selectedIndex}
        ...
        {openAddressList ? (
          <DeliveryChallanAddressListModal
        ...
        <Dialog
          ...
          open={openDeliveryChallanErrorAlertMessage}
          onClose={handleCloseDeliveryChallanErrorAlertMessage}
        ...
        >
          ...
          <DialogActions>
            <Button
              onClick={handleCloseDeliveryChallanErrorAlertMessage}
              color="primary"
              autoFocus
            >
              OK
      ...
      <Dialog
        fullScreen={fullScreen}
        open={openDCLoadingAlertMessage}
        aria-labelledby="responsive-dialog-title"
      >
        <DialogContent>
          <DialogContentText>
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <div style={{ textAlign: 'center' }}>
                <p>
                  Please wait while the Delivery Challan is being created!!!
                </p>
              </div>
              <div>
                <br />
      ...
      <Dialog
        fullScreen={fullScreen}
        open={openDCErrorAlertMessage}
        onClose={handleCloseDCErrorAlertMessage}
        aria-labelledby="responsive-dialog-title"
      >
        <DialogContent>
          <DialogContentText>
            Something went wrong while saving Delivery Challan. Please try
            again!!
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button
            onClick={handleCloseDCErrorAlertMessage}
            color="primary"
            autoFocus
          >
            OK
...
export default injectWithObserver(AddDeliveryChallanInvoice);