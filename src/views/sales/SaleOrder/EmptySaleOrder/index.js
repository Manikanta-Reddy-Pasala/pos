...
const EmptySaleOrderInvoice = () => {
  const classes = useStyles();
  const store = useStore();
  const { openForNewSaleOrder } = store.SaleOrderStore;
  ...
  return (
    <div className={classes.divalign}>
      ...
      <p>
        <Controls.Button
          text="Add your first Sale Order"
          size="small"
          variant="contained"
          color="primary"
          autoFocus={true}
...
export default InjectObserver(EmptySaleOrderInvoice);
