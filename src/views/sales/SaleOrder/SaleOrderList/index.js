...
import MoreOptionsSaleOrder from 'src/components/MoreOptionsSaleOrder';
...
const SaleOrderList = (props) => {
  ...
  const {
    ...
    openSaleOrderPrintSelectionAlert,
    printSaleOrderData
  } = toJS(stores.SaleOrderStore);
  ...
  const {
    openForNewSaleOrder,
    handleCloseSaleOrderPrintSelectionAlertMessage
  } = stores.SaleOrderStore;
  ...
  const closeSaleOrderDialog = () => {
    handleCloseSaleOrderPrintSelectionAlertMessage();
  };

  return (
    <div>
      <Page className={classes.root} title="Sale Order">
        {/* <PageHeader /> */}
      ...
      {openSaleOrderPrintSelectionAlert === true ? (
        <OpenPreview
          open={true}
          onClose={closeSaleOrderDialog}
          id={printSaleOrderData.sequenceNumber}
          invoiceData={printSaleOrderData}
          startPrint={false}
        />
      ) : (
        ''
...
export default InjectObserver(SaleOrderList);